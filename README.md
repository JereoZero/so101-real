...
> ⚠️ **注意**：本仓库包含两个 LeRobot 版本的内容，请留意区分：
>
> | 目录 | LeRobot 版本 | 状态 |
> |------|-------------|------|
> | [`lerobot-0.6/`](./lerobot-0.6/) | **v0.6.0（最新）** | 活跃开发中 |
> | [`踩坑记录/`](./踩坑记录/) | v0.5.1（旧版） | 仅供参考，部分内容已过时 |
> | [`项目流程/`](./项目流程/) | v0.5.1（旧版） | 仅供参考，部分内容已过时 |

---

## LeRobot v0.5.1 版本（历史版本）

> 以下内容基于 LeRobot **v0.5.1**，已完成。最新的 v0.6.0 内容请看上方。
...
- 遇到了问题（v0.5.1） → [踩坑记录/](./踩坑记录/)
- 想了解项目流程（v0.5.1） → [项目流程/workflow.md](./项目流程/workflow.md)
