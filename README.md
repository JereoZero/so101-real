...
> ⚠️ **项目状态**：本文档仍在逐步完善中，细节可能有所调整。基本完善的流程版本请留意 `v0.1.0` 版本的发布。

> 基于 LeRobot + SmolVLA 的机器人模仿学习项目。使用 SO101 双臂机械臂完成"将指定颜色的小方块放入盘子"的任务。
...
> **参考文档**：本项目主要流程参考了同济子豪兄的 LeRobot 系列教程：[子豪兄SO101教程](https://zihao-ai.feishu.cn/wiki/TS6swApHbinx01kHDi5cf5n5n8c)
...
| 推理模型 | V1/V2（25000步/60s）+ V3（40000步/120s） |
